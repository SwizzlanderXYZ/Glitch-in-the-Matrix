...
✅ Dynamic Grid Generation – Supports matrices from 1x1 up to 5x5 with real-time input field generation.
...
Input: 2x3 Matrix ---> Select Inverse
...
Inverse Logic (2x2): Uses the determinant formula det = ad - bc. If det!=0, it applies the adjugate matrix method.
